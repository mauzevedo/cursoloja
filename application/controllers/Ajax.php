        ...
        if ($this->form_validation->run()) {
            ...
            if (!$produto = $this->core_model->get_by_id('produtos', array('produto_id' => $produto_id))) {
                ...
                if (isset($resultado->erro)) {
                    ...
                    $retorno['retorno_endereco'] = $resultado->logradouro . ', ' . $resultado->bairro . ', ' . $resultado->localidade . ' - ' . $resultado->uf . ', ' . $resultado->cep;
                }
                // Final da consulta web service via CEP
                // Inicio da consulta web service dos correios
                ...
                */
                ...
                if ($consulta->cServico[0]->Valor == '0,00') {
                    ...
                    foreach ($consulta->cServico as $dados) {
                        ...
                        $frete_calculado = '<p>' . $dados->Valor . ', Código serviço: ' . $dados->Codigo . '<p>';
